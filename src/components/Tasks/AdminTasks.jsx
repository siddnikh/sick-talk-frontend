  ...
  return (
    <div className="w-screen p-4 md:p-6 bg-gray-100 min-h-screen">
      ...
      <h2 className="text-xl md:text-2xl font-bold text-[#12bb7d] mb-4">
        Tableau de Bord des Tâches Admin
      </h2>
      <button
      ...
      <div className="bg-white p-4 md:p-6 rounded-lg shadow-md mb-4 md:mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-black">
          <input
            ...
            className="p-2 md:p-3 border bg-gray-100 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#12bb7d]"
          />
          <input
            type="number"
            value={reward}
        ...
        <button
          ...
          className="mt-4 bg-[#12bb7d] text-white py-2 px-4 rounded-lg hover:bg-[#0fa96b] transition duration-300 w-full md:w-auto"
        >
          Attribuer la Tâche
        </button>
      </div>
                ...
                >
                  ...
                  {task.status === "pending" && (
                    <button
                      ...
                      className="mt-4 md:mt-0 ml-0 md:ml-4 bg-[#12bb7d] text-white py-2 px-4 rounded-lg hover:bg-[#0fa96b] transition duration-300 w-full md:w-auto"
                    >
