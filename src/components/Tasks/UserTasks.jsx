...
const UserTasks = () => {
  ...
  return (
    <div className="w-screen p-4 md:p-6 bg-gray-100 min-h-screen">
      ...
      <h2 className="text-xl md:text-2xl font-bold text-blue-600 mb-4">Tableau de Bord des Tâches Utilisateur</h2>
      <div className="bg-white p-4 md:p-6 rounded-lg shadow-md mb-4 md:mb-6">
        {loadingUserDetails ? (
          ...
          <>
            ...
            <h3 className="text-lg md:text-xl font-semibold text-gray-700 mb-4">Votre Solde</h3>
